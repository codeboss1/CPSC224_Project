...
public abstract class mainMenu extends JFrame implements ActionListener{
	...
	private static void createButton() {
		...
		tictactoeButton.setPreferredSize(new Dimension(200, 75));
		...
		wordSearchButton.setPreferredSize(new Dimension(200, 75));
		...
		ISpyButton.setPreferredSize(new Dimension(200, 75));
		...
		highScoresButton.setPreferredSize(new Dimension(200, 75));
